...
export function DoctorDashboard() {
  return (
    (<div
      key="1"
      className="flex flex-col w-full min-h-screen dark:bg-black dark:text-white">
        ...
        <div className="flex items-center w-full gap-4 md:ml-auto md:gap-2 lg:gap-4">
          <form className="flex-1 ml-auto sm:flex-initial">
            <div className="relative">
              <SearchIcon
                className="absolute left-2.5 top-2.5 h-4 w-4 text-green-600 dark:text-green-400" />
              <Input
